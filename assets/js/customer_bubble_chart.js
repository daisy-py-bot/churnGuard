...
//     { name: 'Bob', satisfaction: 0.6, tenure: 2, churn: 0.71, service: 'Checking Account', ageGroup: '35-44', location: 'Canada' },
...
//     { name: 'Frank', satisfaction: 0.5, tenure: 1, churn: 0.65, service: 'Credit Card', ageGroup: '35-44', location: 'Canada' },
...
//     { name: 'Frank J', satisfaction: 0.65, tenure: 8, churn: 0.6, service: 'Credit Card', ageGroup: '35-44', location: 'Canada' },
...
//     if (service === 'Savings Account') return '#f44336';
//     if (service === 'Checking Account') return '#ffa726';
//     if (service === 'Credit Card') return '#42a5f5';
...
// // Function to get the color for the service type
// const getColor = (service) => {
//     if (service === 'Savings') return '#f44336';
//     if (service === 'Checking') return '#ffa726';
//     if (service === 'Business') return '#42a5f5';
//     return 'gray'; // For 'Other' or undefined service types
// };
